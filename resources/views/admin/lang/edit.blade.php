            ...
            <div class="container-fluid mt-3">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" class="" id="exampleFormControlInput3" name="active" {{($value->active == 1) ? 'checked' : '' }} value="{{$value->active}}">
                    </div>

                    <div class="form-group">
                        <label for="exampleFormControlInput4"><h5>Шорт название </h5></label>
                        <input type="text" name="shortcut" value="{{$value->shortcut}}" placeholder="" class="form-control" id="exampleFormControlInput4">
                    </div>
